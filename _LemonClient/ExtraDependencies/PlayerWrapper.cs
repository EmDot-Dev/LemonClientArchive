...
{
    static class PlayerWrapper                            //Special thanks to ZeroDay for most of this logic. Condensed the process of getting variables down considerably
    {
        public static HighlightsFXStandalone playerESP = null;
        ...
        public static VRC.Player[] GetAllPlayers() => PlayerManager.field_Private_Static_PlayerManager_0.field_Private_List_1_Player_0.ToArray();
        ...
        internal static Camera GetPlayerCamera() { return VRCVrCamera.field_Private_Static_VRCVrCamera_0.field_Public_Camera_0; }
        ...
        public static void EnableESPState(Renderer renderer)
        {
            playerESP.field_Protected_HashSet_1_Renderer_0.Add(renderer);
        }
        public static void RefreshWallhacks()
        {
            if(GlobalVariables.rainbowESP)
            {
                Color.RGBToHSV(playerESP.highlightColor, out var H, out var S, out var V);
                playerESP.highlightColor = Color.HSVToRGB(H + Time.deltaTime * 0.1f, S, V);
            } else
            {
                playerESP.highlightColor = Color.magenta;
            }
            
        }
        public static void DisableESPState(Renderer renderer)
        {
            playerESP.field_Protected_HashSet_1_Renderer_0.Remove(renderer);
        }
    }
}
